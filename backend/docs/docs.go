    ...
    "paths": {
        ...
        "/api/rules": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Rule data (match_value, category_id, priority required)",
                        "name": "rule",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.TransactionSplit"
                            }
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.splitRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Updated splits",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.TransactionSplit"
